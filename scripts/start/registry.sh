#!/bin/bash
# Start registry (Start Phase - Deployment)
# PURPOSE: Starts registry services/containers.
# USAGE: bash scripts/start/registry.sh
...
log_info "RESULT: registry started"
exit 0
